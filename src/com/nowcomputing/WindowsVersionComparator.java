...
/**
 * This is crap, it is bad, but it maybe works
 *
 * NOTE: might not work on modern java, it's funny because this thing only runs
 * on java 8
 */
public class WindowsVersionComparator implements Comparable<WindowsVersionComparator> {
	...
	public int compareTo(WindowsVersionComparator var1) {
		if (this.major > var1.getMajor()) {
			...
			return this.major == var1.getMajor() && this.minor == var1.getMinor() && this.patch == var1.getPatch() ? 0
					: -1;
		}
	}
