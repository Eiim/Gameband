...
public class GBComms {
	...
	public void setGamebandTimezone() {
		...
		int offsetInMinutes = timeZone.getStandardOffset(currentTime) / '\uea60'; // so fucking dumb, \uea60 is just
																					// 60000, TODO: unfuck this
	...
	public void setGamebandTime() throws IOException {
		...
		try {
			...
			Animation var7;
			for (Iterator var6 = this.animations.iterator(); var6
					.hasNext(); var5 = var5 + var7.getDateFormat() + ":" + var7.getScreen().a() + ",") {
