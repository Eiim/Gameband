...
public class DialogPanel extends JPanel {
	...
	public void l() {
		GamebandPopup.PopupDialog(this, new String[] { LocaleUtil.getLocalizedString("DISCLAIMER_HEADING"),
				LocaleUtil.getLocalizedString("DISCLAIMER_TEXT_1"), LocaleUtil.getLocalizedString("DISCLAIMER_TEXT_2"),
				LocaleUtil.getLocalizedString("DISCLAIMER_TEXT_3"),
				LocaleUtil.getLocalizedString("DISCLAIMER_TEXT_4") }, "Gameband", "www.nowcomputing.com/support");
	}
}
