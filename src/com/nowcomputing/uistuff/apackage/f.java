			...
			if (this.c.isSelected()) {
				...
				if (var5 != null) {
					...
					if (var2 != o.a && var2 != o.c) {
						if (var2 == o.b) {
							GamebandPopup.a(this,
									(new String[] { LocaleUtil.getLocalizedString("ERROR_WRONG_FORMAT_HEADER"),
											LocaleUtil.getLocalizedString("ERROR_NOT_STATIC_IMAGE_1"),
											LocaleUtil.getLocalizedString("ERROR_NOT_STATIC_IMAGE_2") }));
						} else {
							GamebandPopup.a(this,
									(new String[] { LocaleUtil.getLocalizedString("ERROR_WRONG_FORMAT_HEADER"),
											LocaleUtil.getLocalizedString("ERROR_WRONG_FORMAT"),
											LocaleUtil.getLocalizedString("ERROR_NOT_STATIC_IMAGE_2") }));
						}
					} else {
				...
				if (var5 != null) {
					...
					if (var2 != o.a && var2 != o.b) {
						GamebandPopup.a(this,
								(new String[] { LocaleUtil.getLocalizedString("ERROR_WRONG_FORMAT_HEADER"),
										LocaleUtil.getLocalizedString("ERROR_WRONG_FORMAT"),
										LocaleUtil.getLocalizedString("ERROR_NOT_GIF") }));
					} else {
						try {
							this.a.a(var5);
