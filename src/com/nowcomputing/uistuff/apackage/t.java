...
public class t extends JPanel implements MouseListener, MouseMotionListener {
   ...
   public void a(String var1, Direction var2, boolean var3) {
      if (var1 != null && !var1.equals("")) {
         ...
         if (var2 == Direction.left) {
            ...
            var4 = new com.nowcomputing.uistuff.b.l(this, new RawAnimation(GBComms.getThreadPool()), var1, var2, var3);
         }
   ...
   public void a(File var1, Direction var2, boolean var3) {
      try {
         ...
         com.nowcomputing.uistuff.b.j var5 = new com.nowcomputing.uistuff.b.j(this, new RawAnimation(GBComms.getThreadPool()), Image.FromBufferedImage(var4, Math.min(49, var4.getWidth()), Math.min(49, var4.getHeight())), var2, var3);
         this.c(var5);
         var5.a(true);
   ...
   public void a(File var1) {
      com.nowcomputing.uistuff.b.a var2 = new com.nowcomputing.uistuff.b.a(this, new RawAnimation(GBComms.getThreadPool()));
      var2.a(var1);
      this.c(var2);
      var2.a(true);
   }
   ...
   void a(List var1) {
      ...
      while(var5.hasNext()) {
         ...
         case 16:
            ...
            com.nowcomputing.uistuff.b.m var10 = new com.nowcomputing.uistuff.b.m(this, (ImageAnimation)var6, var7);
            this.c(var10);
            break;
         case 17:
      ...
      if (!var2) {
         com.nowcomputing.uistuff.b.n var13 = new com.nowcomputing.uistuff.b.n(this, new TimeAnimation(GBComms.getThreadPool()));
         var13.a(false);
         this.c(var13);
      }

      if (!var3) {
         com.nowcomputing.uistuff.b.b var14 = new com.nowcomputing.uistuff.b.b(this, new DateScreen(GBComms.getThreadPool()));
         var14.a(false);
         this.c(var14);
      }

      if (!var4) {
         com.nowcomputing.uistuff.b.d var15 = new com.nowcomputing.uistuff.b.d(this, new FreeSpaceAnimation(GBComms.getThreadPool()));
         var15.a(false);
         this.c(var15);
      }
