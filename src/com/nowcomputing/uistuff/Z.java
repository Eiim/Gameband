...
public class Z extends BasicRadioButtonUI {
	...
	public synchronized void paint(Graphics var1, JComponent var2) {
		...
		Object var9 = null;
		Object var10 = null;
		String var11 = SwingUtilities.layoutCompoundLabel(var2, var6, var3.getText(),
				var8 != null ? var8 : this.getDefaultIcon(), var3.getVerticalAlignment(), var3.getHorizontalAlignment(),
				var3.getVerticalTextPosition(), var3.getHorizontalTextPosition(), b, c, d,
				var3.getText() == null ? 0 : var3.getIconTextGap());
		if (var2.isOpaque()) {
