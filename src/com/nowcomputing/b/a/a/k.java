...
public class k extends DialogButton {
	...
	public k(com.nowcomputing.b.a.CustomDialog var1, String var2, ImageIcon var3, String var4, Integer var5,
			KeyStroke var6) {
	...
	public void actionPerformed(ActionEvent var1) {
		...
		if (var2 == 0) {
			...
			try {
				...
				GamebandPopup.a((Component) this.a, (String) LocaleUtil.getLocalizedString("IMPORT_FILE_ERROR_TEXT"),
						(String) LocaleUtil.getLocalizedString("IMPORT_FILE_ERROR_TITLE"));
