...
public class AnimatedImage {
	...
	public void exportGIF(File outFile) throws IOException {
		...
		applicationExtension
				.setUserObject(new byte[] { 1, (byte) (mysteryByte & 255), (byte) (mysteryByte >> 8 & 255) });
		...
		while (images.hasNext()) {
			...
			imageWriter.writeToSequence(new IIOImage(image.ToBufferedImage(), (List) null, iioMetadata),
					imageWriteParam);
		}
