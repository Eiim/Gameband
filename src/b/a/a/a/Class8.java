...
public class Class8 implements LayoutManager2 {
			...
			synchronized (var1.getTreeLock()) {
				...
				while (var12.hasNext()) {
					...
					if (!var13.method134()) {
						...
						var13.method140(var11, var6, this.field26, this.field28, this.field27, var9, var10,
								this.field38);
	...
	private void method34() {
		...
		Class32 var2;
		for (Iterator var1 = this.field37.iterator(); var1
				.hasNext(); this.field28 = Math.max(this.field28, var2.method133())) {
	...
	private void method47() {
		...
		if (var1 != null) {
			...
			int var5;
			for (Iterator var3 = var1.method139().iterator(); var3
					.hasNext(); this.field22 = Math.max(this.field22, var5)) {
